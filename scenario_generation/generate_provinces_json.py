...
OUTPUT_FILE = "scenario_ca_provinces.json"
CLEAN_CSV_FILE = "../model_data/canada_provinces_clean.csv"
ADJ_FILE = "../model_data/canada_province_adjacency.csv"
GDF_FILE = "../model_data/canada_provinces.gpkg"
